class OrderDeliverie
  ...
  def save
    order = Order.create(item_id: iitem_id, user_id: user_id)
    Deliverie.create(postal_code: postal_code, source_id: source.id, city: city, address_line1: address_line1, address_line2: address_line2, number: number, order_id: order.id, )
  end
end